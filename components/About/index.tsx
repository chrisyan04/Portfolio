    ...
    <section className="about section" id="about">
        ...
        <div className="about__data">
          ...
          <div className="home__description rounded-lg relative">
            ...
            <span className="text-white/70">
              <TypeAnimation
                sequence={[
                  `name = "Chris Yan"\n education = "2nd yr UofT ml student 👨🏻‍🎓"\n work = "Data Scientist @ Difenda 📊"\n club = "Web Developer @ UTSC DS³ 💻"\n
                  print(f'{name} is a {work}')\nprint(f'He is a {education} and is a {club}')`,
                ]}
                wrapper="span"
                speed={50}
                style={{
      ...
      {resumeToggle && (
        <div className="modal-container">
          <div
            className="modal-background bg-transparent backdrop-blur-sm"
            onClick={handleResumeToggle}
          ></div>
