...
export default function About() {
  return (
    <section
      className="h-screen flex flex-col jusitfy-center items-center pt-4"
      id="about"
    >
      <motion.span
      ...
      <div className="grid max-sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-2 justify-items-center items-center text-[#d4d4d8] mt-10 gap-16">
        <div>
